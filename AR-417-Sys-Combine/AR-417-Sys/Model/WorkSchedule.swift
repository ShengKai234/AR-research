...
class WorkSchedule{
    ...
    init(id: String, scheduleId: String, projectName: String, startDate: String, endDate: String, progress: String, superItem: String, duration: String, superModelGroupId: String, modelName: String, groupId:String, isStart:String, isCheck:String, checkTypeNo:String, superCheckNo:String, budget:Int, cost:Int){
        self._id = id
